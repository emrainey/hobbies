...
public:
    ...
    iterator_const begin(void) const noexcept { return &m_cameras[0]; }
    /// @brief One past the end of the cameras
    iterator end(void) noexcept { return &m_cameras[NumberOfCameras]; }
    /// @brief One past the end of the cameras
    iterator_const end(void) const noexcept { return &m_cameras[NumberOfCameras]; }

    /// @brief Returns the amount of toe-in for the cameras
    iso::radians toe_in(void) const noexcept { return m_toe_in; }
