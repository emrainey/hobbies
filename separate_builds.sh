...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        ;;
        -distcc)
            DISTCC=("-DCMAKE_C_COMPILER_LAUNCHER=distcc" "-DCMAKE_CXX_COMPILER_LAUNCHER=distcc")
        ;;
        -del)
        ...
        -gcc)
            ...
            CC=/opt/homebrew/bin/aarch64-apple-darwin23
            CXX=/opt/homebrew/bin/aarch64-apple-darwin23
        ;;
        *)
        ;;
    esac
