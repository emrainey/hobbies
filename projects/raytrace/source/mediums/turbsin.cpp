...
turbsin::turbsin(precision xs, precision ys, precision power, precision size, precision scale, color dark, color light)
    : opaque{}, m_pad{}, m_dark{dark}, m_light{light}, m_xs{xs}, m_ys{ys}, m_power{power}, m_scale{scale}, m_size{size} {
