 ...
 */
inline element_type fresnel(element_type n1, element_type n2, const iso::radians& theta_i,
 ...
 */
inline element_type penetration_depth(element_type permeability, element_type permittivity, element_type resistivity,
 ...
 * @param C The coefficient of dropoff in the medium. Values can be from 0-1 inclusive. Values under 0.2 look more
 * transparent.
 */
