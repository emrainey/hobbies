...
public:
    ...
    constexpr const element_type& red() const { return channels[0]; }
    constexpr const element_type& green() const { return channels[1]; }
    constexpr const element_type& blue() const { return channels[2]; }
    constexpr const element_type& intensity() const { return channels[3]; }
