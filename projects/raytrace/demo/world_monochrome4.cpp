...
public:
    MonochromeWorld()
        ...
        , light_subsamples{5}
        , light0{raytrace::point{-5, 0, 40}, 1, colors::white, lights::intensities::full, light_subsamples}
        , light1{raytrace::point{5, 0, 40}, 1, colors::white, lights::intensities::full, light_subsamples}
        , beam0{-R3::basis::Z, colors::white, lights::intensities::full * 1.5_p}
