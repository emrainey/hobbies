...
void convert(const linalg::matrix& mat, fourcc::image<PIXEL_TYPE, PIXEL_FORMAT>& image,
    ...
    basal::exception::throw_unless(
        PIXEL_FORMAT == fourcc::pixel_format::GREY8 or PIXEL_FORMAT == fourcc::pixel_format::Y8 or
            PIXEL_FORMAT == fourcc::pixel_format::Y16 or PIXEL_FORMAT == fourcc::pixel_format::Y32,
        __FILE__, __LINE__);
