...
image::image(size_t width, size_t height) : fourcc::image<fourcc::PixelFormat::Y16>{width, height} {
}

void image::generate_sample(fractals::image::sampler sampler_func, uint16_t max_iterations,
