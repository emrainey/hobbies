...
template <class LeftType, class RightType> class compound {
static_assert(not std::is_same<LeftType, RightType>::value, "Must be different types!");
static_assert(std::is_same<typename LeftType::type, typename RightType::type>::value, "Unit types must be the same!");
public:
