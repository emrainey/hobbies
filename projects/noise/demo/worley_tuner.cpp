...
void generate_noise_image(void) {
    noise_image.for_each([&](int y, int x, fourcc::rgb8 &pixel) {
        ...
        noise::precision n = noise::worley(pnt, scale, seed, gain);
...
int main(int argc __attribute__((unused)), char *argv[] __attribute__((unused))) {
    ...
    std::string windowName{"Worley Image"};
    ...
    do {
        ...
        snprintf(buffer, sizeof(buffer), "Worley Noise Angle:%lf seed:{%lf,%lf} gain:%lf scale:%lf", angle.value,
