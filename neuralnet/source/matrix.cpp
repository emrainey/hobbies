...
namespace nn {
    ...
    matrix sigmoid(const matrix& mat) {
        ...
        return m.for_each([&](size_t y, size_t x, double& v) {
            v = sigmoid(mat[y][x]);
        });
    }
