...
namespace htm {
    ...
    protected:
        ...
        template <size_t B2> friend sparse_word<B2> operator&(const sparse_word<B2>& a, const sparse_word<B2>& b);
        template <size_t B2> friend sparse_word<B2> operator|(const sparse_word<B2>& a, const sparse_word<B2>& b);
        template <size_t B2> friend sparse_word<B2> operator^(const sparse_word<B2>& a, const sparse_word<B2>& b);
        template <size_t B2> friend sparse_word<B2> operator!(const sparse_word<B2>& a);
        //template <size_t B1, size_t B2> friend sparse_word<B1+B2> operator<<(const sparse_word<B1> &, const sparse_word<B2>&);
    ...
    sparse_word<BITS> operator&(const sparse_word<BITS>& a, const sparse_word<BITS>& b) {
        ...
        std::set_intersection(a.bits.begin(), a.bits.end(),
    ...
    sparse_word<BITS> operator|(const sparse_word<BITS>& a, const sparse_word<BITS>& b) {
        std::vector<uint16_t> o;
        std::set_union(a.bits.begin(), a.bits.end(),
                       b.bits.begin(), b.bits.end(),
                       std::back_inserter(o));
        return sparse_word<BITS>(o);
    }
    ...
    sparse_word<BITS> operator^(const sparse_word<BITS>& a, const sparse_word<BITS>& b) {
        std::vector<uint16_t> o;
        std::set_difference(a.bits.begin(), a.bits.end(),
                            b.bits.begin(), b.bits.end(),
                            std::back_inserter(o));
        return sparse_word<BITS>(o);
    }
