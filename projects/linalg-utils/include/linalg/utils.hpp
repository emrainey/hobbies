...
void convert(linalg::matrix const& mat, fourcc::image<PixelFormat>& image,
    ...
    basal::exception::throw_unless(PixelFormat == fourcc::PixelFormat::GREY8 or PixelFormat == fourcc::PixelFormat::Y8
                                       or PixelFormat == fourcc::PixelFormat::Y16
                                       or PixelFormat == fourcc::PixelFormat::Y32,
                                   __FILE__, __LINE__);
