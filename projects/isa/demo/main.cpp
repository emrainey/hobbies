...
int main(int argc, char* argv[]) {
    ...
    program demo_program = {
        ...
        Instruction{MoveImmediateToScratch{Operand{OperandType::Scratch,3}, Immediate<20>{0x12344}}},
        Instruction{MoveImmediateToScratch{Operand{OperandType::Scratch,5}, Immediate<20>{0x12346}}},
        Instruction{Move{Operand{OperandType::Scratch, 1}, Operand{OperandType::Scratch, 0}, true,
                                         Move::ImmediateType{4}}},
        Instruction{Swap{Operand{OperandType::Scratch, 0}, Operand{OperandType::Scratch, 4}}},
        Instruction{Compare{Operand{OperandType::Evaluation, 0}, Operand{OperandType::Scratch, 0}, Operand{OperandType::Scratch, 3}}},
        Instruction{Compare{Operand{OperandType::Evaluation, 1}, Operand{OperandType::Scratch, 1}, Operand{OperandType::Scratch, 3}}},
        Instruction{Compare{Operand{OperandType::Evaluation, 2}, Operand{OperandType::Scratch, 3}, Operand{OperandType::Scratch, 5}}},
        Instruction{Compare{Operand{OperandType::Evaluation, 3}, Operand{OperandType::Scratch, 1}, Operand{OperandType::Scratch, 4}}},
