...
public:
    ...
    raytrace::animation::anchors get_anchors() const override {
        ...
        anchors.push_back(animation::Anchor{animation::Attributes{looking_from(), looking_at(), 45.0_deg},
                                            animation::Attributes{raytrace::point{0, 30, 22}, looking_at(), 25.0_deg},
                                            animation::Mappers{}, iso::seconds{3.0_p}});
        anchors.push_back(animation::Anchor{anchors.back().limit,  // previous limit is this start
                                            animation::Attributes{raytrace::point{-30, 0, 22}, looking_at(), 45.0_deg},
                                            animation::Mappers{}, iso::seconds{3.0_p}});
        return anchors;
    }
