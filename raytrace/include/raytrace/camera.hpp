...
namespace raytrace {
    ...
    public:
         ...
         * Updates other values accordingly. The distance between the look_from and look_at will establish the "scale" of the scene.
    ...
    protected:
        ...
        linalg::matrix m_camera_to_object_rotation; ///< Rotates the Camera Coordinate frame into the Object Coordinate frame.
    };
}
